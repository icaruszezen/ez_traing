...
from PyQt5.QtWidgets import (
    ...
    QMenu, QMessageBox, QScrollArea, QToolButton, QVBoxLayout,
    QWidget, QWidgetAction,
)

from ez_traing.labeling.combobox import ComboBox
from ez_traing.labeling.default_label_combobox import DefaultLabelComboBox
from ez_traing.labeling.constants import *
from ez_traing.labeling.utils import *
from ez_traing.labeling.settings import Settings
from ez_traing.labeling.shape import Shape, DEFAULT_LINE_COLOR, DEFAULT_FILL_COLOR
from ez_traing.labeling.string_bundle import StringBundle
from ez_traing.labeling.canvas import Canvas
from ez_traing.labeling.zoom_widget import ZoomWidget
from ez_traing.labeling.light_widget import LightWidget
from ez_traing.labeling.label_dialog import LabelDialog
from ez_traing.labeling.color_dialog import ColorDialog
from ez_traing.labeling.label_file import LabelFile, LabelFileError, LabelFileFormat
from ez_traing.labeling.tool_bar import ToolBar
from ez_traing.labeling.pascal_voc_io import PascalVocReader, XML_EXT
from ez_traing.labeling.yolo_io import YoloReader, TXT_EXT
from ez_traing.labeling.create_ml_io import CreateMLReader, JSON_EXT
from ez_traing.labeling.ustr import ustr
from ez_traing.labeling.hashable_item import HashableQListWidgetItem
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def show_info_dialog(self):
        msg = u'Name:{0} \nApp Version:{1} \n{2} '.format(__appname__, '1.8.6', sys.version_info)
    ...
    def load_file(self, file_path=None):
        ...
        if unicode_file_path and os.path.exists(unicode_file_path):
            if LabelFile.is_label_file(unicode_file_path):
                ...
                if self.label_file.lineColor:
                    self.line_color = QColor(*self.label_file.lineColor)
                if self.label_file.fillColor:
