...
from ez_training.common.constants import SUPPORTED_IMAGE_FORMATS, load_settings
from ez_training.labeling.annotation_window import AnnotationWindow
from ez_training.labeling.label_file import LabelFile, LabelFileFormat
from ez_training.ui.workers import ImageScanWorker, ThumbnailLoader
    ...
    def _ensure_sample_dataset_dir(self) -> Optional[str]:
        ...
        if self._project_manager:
            ...
            if not already_exists:
                from ez_training.pages.dataset_page import DatasetProject
